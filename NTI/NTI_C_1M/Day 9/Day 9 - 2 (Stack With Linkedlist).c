...
while(1){
     ...
     printf("enter your choice :\n");
        printf("1 to push elements to stack \t 2 to pop element of stack \t 3 to  print element of stack \t 4 to print top value \t 5 to print number of stack \n ");
        scanf("%i",&choice);
        printf("\n \n");
        switch(choice)
        {
    ...
    case 5:
        ...
        {
            printf("number of stack elements is %i",stack_count());
        }
